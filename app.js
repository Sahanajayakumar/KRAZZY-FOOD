...
var mongourl = "mongodb+srv://Sahana:sahana@cluster0.5tmrt.mongodb.net/KrazzyFood?retryWrites=true&w=majority";
...
app.get('/',(req,res) => {
    res.send(`<a href="http://localhost:2190/location" target="_blank">City</a> <br/> <a href="http://localhost:2190/mealtype" target="_blank">MealType</a> <br/> <a href="http://localhost:2190/cuisine" target="_blank">Cuisine</a> <br/> <a href="http://localhost:2190/restaurants" target="_blank">Restaurants</a> <br/> <a href="http://localhost:2190/orders" target="_blank">Orders</a>`)
})
